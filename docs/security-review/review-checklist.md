...
- [ ] **R-11 — Abuse controls.** Reproduce source-address derivation, configurable
  ...
  reconnect/final authentications, 2,000 exact online deliveries, at least 100
  frames/s, RSS growth at most 128 MiB, and bounded descriptor／handle cleanup.
  Test distributed proxy coordination and the intended TLS/load-balancer/container/
