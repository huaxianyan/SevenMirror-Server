...
- [ ] **B-02 — Vulnerability scan.** Server CI runs `govulncheck v1.1.4` against
  ...
  subjects; provider database time remains explicitly null. Default-branch and
  published-manifest evidence are verified; all Android and Server build-tool
