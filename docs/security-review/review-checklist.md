...
- [ ] **B-02 — Vulnerability scan.** Server CI runs `govulncheck v1.1.4` against
  ...
  builder-only Alpine packages. Default-branch and published-manifest evidence
  are verified; Android OSV query-time evidence and all build-tool dispositions
  remain open. (`PARTIAL`; SR-003)
